...
> **MỤC ĐÍCH:** Bản đồ này giúp AI và Developer nắm bắt tổng quan kiến trúc hệ thống, các module chính và tiến độ mà không cần tốn token (quét lại thư mục nhiều lần). **Quy tắc: Luôn đọc file này khi bắt đầu module mới và cập nhật file này sau khi hoàn thành tính năng.**
...
---
*Last updated: (Hệ thống AI sẽ tự động update dòng này)*
