...
export const EmailSettingsSchema = z.object({
  ...
  email_branch_address: z.string().optional(),
  email_manage_booking_url: z.string().url("Link quản lý đơn không hợp lệ").optional().or(z.literal('')),
  email_grace_minutes: z.number().int().min(0).max(120).optional(),
