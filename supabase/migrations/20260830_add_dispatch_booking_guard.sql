-- 20260830_add_dispatch_booking_guard.sql
-- Thêm guard kiểm tra mã đơn thật để chặn lỗi lưu mã ảo từ giao diện
-- Base from: 20260816221146_fix_turnledger_parent_booking_id.sql
