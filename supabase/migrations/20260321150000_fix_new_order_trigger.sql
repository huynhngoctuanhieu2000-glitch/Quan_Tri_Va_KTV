-- =============================================================================
-- FIX NEW_ORDER NOTIFICATION TRIGGER FOR KTV
-- =============================================================================
...
BEGIN
    ...
    IF (TG_OP = 'UPDATE') THEN
        ...
        -- Đã bỏ điều kiện: OR (OLD.status::text != NEW.status::text AND NEW.status::text = 'PREPARING')
        -- Vì KTV tự chuyển sang chặng 2 sẽ tự động cập nhật status thành PREPARING, dẫn đến bị lặp lại thông báo đơn mới.
