-- ============================================================================
-- FIX: Prevent dispatch_confirm_booking from overwriting TurnQueue times if working
-- 
-- ROOT CAUSE:
--   When Reception clicks Dispatch on an already IN_PROGRESS booking (e.g. to add note),
--   the RPC updates TurnQueue using ON CONFLICT DO UPDATE.
--   It correctly preserved status='working', but blindly overwrote "start_time" 
--   and "estimated_end_time" with the PLANNED times from the UI.
--
-- FIX:
--   Wrap start_time and estimated_end_time updates in TurnQueue with a CASE WHEN
--   to strictly preserve the existing times if status = 'working'.
-- ============================================================================
