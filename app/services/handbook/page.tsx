...
export default function ServiceHandbookPage() {
  ...
  if (!hasPermission('service_handbook')) {
    return (
      <AppLayout>
      ...
      <div className="space-y-6 h-[calc(100vh-8rem)] flex flex-col">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Quy trình chuẩn cho các dịch vụ tại Spa.</p>
          </div>
        ...
        <div className="flex-1 flex gap-6 overflow-hidden">
          ...
          <div className="w-full sm:w-80 flex flex-col bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden shrink-0">
            <div className="p-4 border-b border-gray-50 bg-gray-50/30">
              <h2 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Danh mục quy trình</h2>
            </div>
                ...
                >
                  <div className="max-w-3xl mx-auto space-y-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500">
                          <div className="flex items-center gap-1.5">
                            ...
                            Thời lượng: <span className="font-bold text-gray-900">{selectedItem.duration}</span>
                          </div>
                        </div>
                      </div>
                      {canEdit && (
                    ...
                    <div className="space-y-6">
                      <h3 className="font-bold text-lg text-gray-900 border-b border-gray-100 pb-2">Các bước thực hiện</h3>
                      <div className="space-y-4">
                ...
                >
                  <div className="max-w-3xl mx-auto space-y-8">
                    <div className="flex justify-between items-center">
                      <h2 className="text-2xl font-bold text-gray-900">Chỉnh sửa quy trình</h2>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-400 uppercase">Tên dịch vụ</label>
                        <input 
                          type="text"
                      ...
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-400 uppercase">Thời lượng</label>
                        <input 
                          type="text"
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <h3 className="font-bold text-gray-900">Các bước thực hiện</h3>
                        <button 
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-gray-400 uppercase">Lưu ý quan trọng</label>
                      <textarea 
