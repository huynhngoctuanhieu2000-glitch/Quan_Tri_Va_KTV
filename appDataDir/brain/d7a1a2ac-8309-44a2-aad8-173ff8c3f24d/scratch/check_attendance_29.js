...
async function checkAttendance() {
    const { data: att } = await supabase.from('KTVAttendance').select('*').gte('checkedAt', '2026-04-29T00:00:00Z').lte('checkedAt', '2026-04-29T23:59:59Z');
    console.log(`Total Attendance Records for 29/4: ${att?.length || 0}`);
